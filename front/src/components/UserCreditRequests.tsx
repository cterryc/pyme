  ...
  return (
    <div className='w-full px-2 sm:px-4 lg:px-0'>
      <div className='flex flex-col sm:flex-row items-start sm:items-center gap-3 sm:gap-4 mb-6'>
        ...
        <div>
          <h2 className='text-3xl sm:text-4xl font-bold text-gray-900 mb-1'>Solicitudes de Crédito</h2>
                      ...
                      .map((credit: CreditAppplication) => {
                        ...
                        return (
                          <tr key={credit.id} className='hover:bg-blue-50/50 transition-colors duration-150'>
                            ...
                            <td className='p-3'>
                              <span
                                className={`inline-block px-3 py-1.5 rounded-full text-xs font-semibold text-center whitespace-nowrap ${typeStatus(
                                  credit.status
                                )}`}
                              >
                                {credit.status}
