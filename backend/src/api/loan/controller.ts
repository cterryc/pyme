...
export default class LoanController {
  ...
  static createCreditApplication = async (req: Request, res: Response, next: NextFunction) => {
    try {
      ...
      const loanRequest: responseLoanRequest | null = await this.loanService.createCreditApplication(
        loanData.id,
  ...
  static updateCreditApplicationStatus = async (req: Request, res: Response, next: NextFunction) => {
    try {
  ...
  static getCreditApplicationsForAdmin = async (req: Request, res: Response, next: NextFunction) => {
    try {
      ...
      const result = await this.loanService.getCreditApplicationsForAdmin(page, limit, status as any, companyName)
  ...
  static apiFirma = async (req: Request, res: Response, next: NextFunction) => {
    ...
    try {
      ...
      return res.status(saveData).json({ message: 'Gracias por firmarlo pa!' })
    } catch (error) {
      return next(error)
    }
  }
